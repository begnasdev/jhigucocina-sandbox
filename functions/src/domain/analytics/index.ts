/**
 * PURPOSE
 *   analytics domain core — rollup aggregation logic (Doc C analytics).
 *
 * EXPLANATION
 *   PURE business logic for the analytics workflow. NO Firebase/Functions imports
...
export const __domain = "analytics" as const;
