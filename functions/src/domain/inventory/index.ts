/**
 * PURPOSE
 *   inventory domain core — stock movement application, valuation, thresholds (Doc C #3).
 *
 * EXPLANATION
 *   PURE business logic for the inventory workflow. NO Firebase/Functions imports
...
export const __domain = "inventory" as const;
