/**
 * PURPOSE
 *   recipe domain core — recursive BOM explosion + cost rollup (Doc C cross-cutting).
 *
 * EXPLANATION
 *   PURE business logic for the recipe workflow. NO Firebase/Functions imports
...
export const __domain = "recipe" as const;
