/**
 * PURPOSE
 *   order domain core — order lifecycle + item roll-up (Doc C #1,#2).
 *
 * EXPLANATION
 *   PURE business logic for the order workflow. NO Firebase/Functions imports
...
export const __domain = "order" as const;
